  ...
  return (
    <footer className="fixed bottom-0 z-0 w-full bg-acadia py-[72px] text-center dark:bg-blackPearl">
      ...
      <p className="font-sans font-medium text-scotchMist">
        Copyright &copy;2023. <a href="https://ahhacreative.com" target="_target" rel="noreferrer" className="underline hover:no-underline">Ah Ha Creative, LLC</a>. All Rights Reserved<br/>
